...
public class InventoryProviderTest {
  ...
  @State(value = "valid Inventory returned with valid id")
  public void getInventory() {
	  Inventory inventory=new Inventory("TV", "ODISHA", 1000);
	  when(inventoryService.getInventory(any(Integer.class))).thenReturn(inventory) ;
  }
}